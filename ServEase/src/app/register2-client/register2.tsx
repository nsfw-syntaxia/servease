...
const ClientSignup2: NextPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      router.push("/register3"); // ✅ navigate to RegisterPage3
    } catch (error: any) {
    ...
    <div className={styles.clientSignup2}>
      ...
      <div className={styles.joinUs}>
        <div className={styles.conten}>
          ...
          <div className={styles.backContainer} onClick={handleBack} style={{ display: 'flex', alignItems: 'center', cursor: 'pointer', margin: '20px 0' }}>
            <Image className={styles.outlineArrowsArrowLeft} width={24} height={24} sizes="100vw" alt="Back" src="Arrow Left.svg" />
                  ...
                  <div className={styles.inputButton}>
                    <div className={styles.input}>
                      ...
                      <input
                        ...
                        style={{ flex: 1, border: "none", outline: "none", background: "transparent", fontSize: "16px" }}
                      />
                    </div>
                    <button
                      ...
                      style={{ backgroundColor: isPhoneValid ? "#a68465" : "#ccc", cursor: isPhoneValid ? "pointer" : "not-allowed" }}
                    >
                    ...
                    <div className={styles.form}>
                      <div className={styles.resendCode}>
                        ...
                        <div
                          ...
                          style={{ opacity: timer === 0 ? 1 : 0.4, cursor: timer === 0 ? "pointer" : "not-allowed" }}
