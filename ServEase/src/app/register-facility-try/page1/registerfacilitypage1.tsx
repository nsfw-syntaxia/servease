...
const FacilitySignup1: NextPage = () => {
  ...
  const handleNextClick = () => {
    ...
    if (hasError) return;
    router.push("/register-facility-try/page2");
          ...
          <StepTransitionWrapper>
            <div className={styles.frameParent}>
              <div className={styles.frameGroup}>
                <div className={styles.frameContainer}>
                  <div className={styles.numberParent}>
                    ...
                    <div className={styles.provideKeyDetails}>
                      Provide key details about your service facility that will
                      be visible to clients browsing and booking services
                ...
                <Link href="/register-facility-try/page2">
